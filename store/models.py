...
class Product(models.Model):
    ...
    picture = models.ImageField(upload_to="img", default="", validators=[
                                validate_image_size], blank=True)
...
class Cart(models.Model):
    ...
    def total_price(self):
        ...
        # in this way we are loading data on memory but or test we can use it
